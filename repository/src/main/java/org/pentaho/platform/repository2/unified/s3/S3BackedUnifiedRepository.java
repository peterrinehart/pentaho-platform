...
public class S3BackedUnifiedRepository implements IUnifiedRepository {
  private S3RepositoryFileDao repositoryFileDao;

  public S3BackedUnifiedRepository( final String baseDir ) {
    this( new S3RepositoryFileDao( baseDir ) );
  }

  public S3BackedUnifiedRepository( final File baseDir ) {
    this( new S3RepositoryFileDao( baseDir ) );
  }

  public S3BackedUnifiedRepository() {
    this( new S3RepositoryFileDao() );
  }

  public S3BackedUnifiedRepository( final S3RepositoryFileDao repositoryFileDao ) {
